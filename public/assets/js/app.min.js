...
var LeftSidebar =
    ...
    return _createClass(t, [{
        key: "toggleRightSideBar", value: function () {
        ...
        key: "initMenu", value: function () {
            ...
            var e = document.querySelectorAll("ul.navbar-nav .dropdown .dropdown-toggle"), a = !1;
    ...
    function t() {
        _classCallCheck(this, t), this.body = document.body, this.defaultConfig = {
            leftbar: {
                ...
                size: "default",
                position: "fixed"
            }, layout: {color: "light", size: "fluid", mode: "default"}, topbar: {color: "light"}, sidebar: {user: !0}
        }
    }
...
window.addEventListener("DOMContentLoaded", function (t) {
    ...
    t.prototype.init = function () {
        ...
        a(document).on("click", this.$portletCloser, function (t) {
            t.preventDefault();
            var e = a(this).closest(n.$portletIdentifier), t = e.parent();
    ...
    t.prototype.initControls = function () {
        ...
        var a = document.getElementById("liveAlertPlaceholder"), e = document.getElementById("liveAlertBtn");
