        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-4">
                <div class="text-center">
                    <a href="index.html">
                        <img src="../public/assets/images/logo-dark.png" alt="OWESIS" height="22" class="mx-auto">
                    </a>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-muted">Back to <a href="/admin/auth/login" class="text-dark ms-1"><b>Log in</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
