                    ...
                    <div class="card">
                        <div class="bg-picture card-body">
                            <div class="d-flex align-items-top">
                                <img src="../public/assets/images/users/profile.jpg"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-top mb-2">
                                <img src="../public/assets/images/users/user-1.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                                <div class="flex-grow-1">
                                    ...
                                    <div>
                                        <a href="">
                                            <img src="../public/assets/images/small/img-1.jpg" class="avatar-md rounded">
                                        </a>
                                        <a href="">
                                            <img src="../public/assets/images/small/img-2.jpg" class="avatar-md rounded">
                                        </a>
                                        <a href="">
                                            <img src="../public/assets/images/small/img-3.jpg" class="avatar-md rounded">
                                        </a>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-top mb-2">
                                        <img src="../public/assets/images/users/user-3.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-top">
                                        <img src="../public/assets/images/users/user-4.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-top mb-2">
                                                <img src="../public/assets/images/users/user-5.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-top mb-3">
                                <img src="../public/assets/images/users/user-6.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-top mb-3">
                                <img src="../public/assets/images/users/user-7.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                                <div class="flex-grow-1">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group mb-0 user-list">
                                <li class="list-group-item">
                                    <a href="#" class="user-list-item">
                                        <div class="user avatar-sm float-start me-2">
                                            <img src="../public/assets/images/users/user-2.jpg" alt="" class="img-fluid rounded-circle">
                                        </div>
                                        <div class="user-desc">
                                ...
                                <li class="list-group-item">
                                    <a href="#" class="user-list-item">
                                        <div class="user avatar-sm float-start me-2">
                                            <img src="../public/assets/images/users/user-3.jpg" alt="" class="img-fluid rounded-circle">
                                        </div>
                                        <div class="user-desc">
                                ...
                                <li class="list-group-item">
                                    <a href="#" class="user-list-item">
                                        <div class="user avatar-sm float-start me-2">
                                            <img src="../public/assets/images/users/user-5.jpg" alt="" class="img-fluid rounded-circle">
                                        </div>
                                        <div class="user-desc">
                                ...
                                <li class="list-group-item">
                                    <a href="#" class="user-list-item">
                                        <div class="user avatar-sm float-start me-2">
                                            <img src="../public/assets/images/users/user-6.jpg" alt="" class="img-fluid rounded-circle">
                                        </div>
                                        <div class="user-desc">
                                            <h5 class="name mt-0 mb-1">Michael Zenaty</h5>
                                ...
                                <li class="list-group-item">
                                    <a href="#" class="user-list-item">
                                        <div class="user avatar-sm float-start me-2">
                                            <img src="../public/assets/images/users/user-1.jpg" alt="" class="img-fluid rounded-circle">
                                        </div>
                                        <div class="user-desc">
