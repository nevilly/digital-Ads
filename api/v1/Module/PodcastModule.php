...
class PodcastModule extends Database
{
    ...
    public function get($id = '',$limit =''){
        ...
        return parent::query(parent::encode(['query'=>"Select u.username,u.avatar,p.* from $this->table as p left join users as u ON(p.user = u.id) $where $limit"]));
    }
