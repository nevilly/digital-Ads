...
class CVModule extends Database
{
     ...
     * @return mixed
     */
    public function checkCV($file){
        return parent::select(parent::encode(array("table"=>$this->table,'cols'=>"id",'where'=>"cv Like '%$file'", 'limit'=>1)));
    }
