    ...
    public function add(){
        ...
        if(!empty($title) && !empty($desc) && !empty($cover)){
            ...
            if(!parent::checkPodcast($title)){
                $sql = parent::addPodcast(parent::encode(array("title"=>$title,"description"=>$desc,'user'=>$user_id,"image"=>$cover)));
